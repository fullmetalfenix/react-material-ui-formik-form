      ...
      <form id="whole-form" onSubmit={formik.handleSubmit}>
        ...
        >
          ...
          {formik.touched.fullName && formik.errors.fullName ? (
            <div className="error" style={{marginTop: 10, background: 'rgba(250,250,250,.87)', color: '#0a1929', padding: 3, borderRadius: 20}}>
              <ArrowUpwardIcon />
          ...
          {/* <Button style={{ padding: 20, marginTop: 40 }} type="submit" variant="contained">
            Submit
          </Button> */}
...
<Button onClick={()=>{alert(formik.getFieldProps)}}> Check Errors</Button>
